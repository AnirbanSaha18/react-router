...
function MovieDetails() {
    // const params = useParams();// This hook returns an object and we store that object in params variable.
    // console.log(params);
  ...
  return (
    ...
    {/* <h1>Hello World</h1> //Because in the path we write movieID thats why it is movieID
     */}
